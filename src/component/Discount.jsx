        ...
        <div className="md:bg-transparent bg-zinc-100 flex md:flex-row flex-col  max-w-[1400px] mx-auto px-10 py-10">
           ...
           <div className="max-w-[700px]">
              ...
              <p className="text-zinc-600 my-6"> 
                Enjoy an executive first order discount on your grocery website! shop fresh essential and save big on your first purchase. Fast delivery and Quality guaranted.
              </p>
